...
NERD_FONTS_TITLE="DroidSansMono Nerd Font"
NERD_FONTS_FILENAME="Droid Sans Mono Nerd Font Complete.otf"
NERD_FONTS_SOURCE_PATH="$NERD_FONTS_SOURCE_DIR/$NERD_FONTS_FILENAME"
...
Linux)
    ...
    FONTS_INSTALLED=`fc-list | grep "$NERD_FONTS_TITLE" | wc -l`
    ;;
CYGWIN*|MINGW*|MSYS*)
    exit 1
    ;;
